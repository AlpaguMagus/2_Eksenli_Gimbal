...
| **K2** · 🔧 firmware + 🧪 lag-kanıtlı | + **Gyro feedforward** (2-DOF) | bozucuyu doğrudan ileri-besle (gy_dps) | bedava sinyal | sim 4.1× reddi-bant; firmware+gate; **lag faydası ÖLÇÜLDÜ** (165→0 ms, §12.9); **HP k_ff 9.7→20 DÜZELTİLDİ §12.14.7** (önce LP-placeholder); rijit re-validate kullanıcı-eğmesi bekler `§12.7/§12.9` | 3.8 |
