...
- **Test ID:** 20260623_204449
- **Tarih:** 2026-06-23 20:45
- **Commit:** `bd801c2`
...
| Metrik | Değer |
|---|---|
| Eğme genliği (FP aralığı) | 79.5° (-35.9…43.6) |
| Takip RMS (θ−ref) | **5.08°** |
| Hareketli pencere RMS | 5.61° |
| Max |hata| | 15.5° |
| Örnek sayısı | 3752 |
...
## Yorum
🟢 Motor-2 IMU pitch'ini takip etti, RMS 5.08° (<10° hedef). Aşama 2.7 mirror (sağlıklı ünite ~4.02°) ile mertebe-uyumlu → instance-based MIRROR yolu gerçek-donanımda doğrulandı. Hızlı el bant limitini aşar (beklenen).
