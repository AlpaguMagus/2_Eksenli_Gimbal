...
- **Test ID:** 20260623_204200
- **Tarih:** 2026-06-23 20:42
- **Commit:** `fca5ec1`
...
| Metrik | Değer |
|---|---|
| Eğme genliği (FP aralığı) | 143.4° (-74.2…69.2) |
| Takip RMS (θ−ref) | **5.40°** |
| Hareketli pencere RMS | 6.09° |
| Max |hata| | 15.4° |
| Örnek sayısı | 3752 |
...
## Yorum
🟢 Motor-2 IMU pitch'ini takip etti, RMS 5.40° (<10° hedef). Aşama 2.7 mirror (sağlıklı ünite ~4.02°) ile mertebe-uyumlu → instance-based MIRROR yolu gerçek-donanımda doğrulandı. Hızlı el bant limitini aşar (beklenen).
